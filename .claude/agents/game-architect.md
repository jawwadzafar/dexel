...
**On finish:**
1. Your primary artifact contract: `docs/plan/ROADMAP.md` plus, for a phase big enough to need one, its own `docs/plan/<PHASE>-design.md`. Report the paths you wrote and what changed in them.
